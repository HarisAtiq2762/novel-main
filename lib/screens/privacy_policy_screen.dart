...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Privacy Policy',style: TextStyle(color: globals.primaryTextColor),),
        leading: IconButton(
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(snapshot.data[index]['privacy_policy'],style: TextStyle(fontSize: 15.sp,fontWeight: FontWeight.w300,color: Colors.black)),
                    ],
                  ),
                );
              },
  ...
  Future getPrivacyPolicy()async{
    var request = http.Request('GET', Uri.parse(globals.baseUrl+'privacy_policy_api'));
